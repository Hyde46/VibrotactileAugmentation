...
public abstract class HandModel : MonoBehaviour {
  ...
  */
  public Vector3 GetHandOffset() {
    ...
    return controller_.transform.TransformPoint(scaled_wrist_position) -
           controller_.transform.position + this.ExternalOffset;
  }
  ...
  */
  public Vector3 GetPalmPosition() {
    ...
    if (this.controller_.GetType() == typeof(ExperimentHandController))
    {
        //offsetVector.x += (this.controller_ as ExperimentHandController).xOffset;
    }

    if (controller_ != null && hand_ != null) {
        return controller_.transform.TransformPoint(hand_.PalmPosition.ToUnityScaled(mirror_z_axis_)) + GetHandOffset() + offsetVector;
    }
    if (palm) {
        return palm.position + offsetVector;
    }
    return Vector3.zero + offsetVector;
  }
  ...
  */
  public Vector3 GetArmCenter() {
    ...
    if (controller_ != null && hand_ != null) {
      ...
      return controller_.transform.TransformPoint(leap_center.ToUnityScaled(mirror_z_axis_)) + GetHandOffset() + offsetVector;
    }
    if (forearm) {
        return forearm.position + offsetVector;
    }
    return Vector3.zero + offsetVector;
  }
  ...
  */
  public Vector3 GetElbowPosition() {
    ...
    if (controller_ != null && hand_ != null) {
      ...
      return controller_.transform.TransformPoint(local_position) + GetHandOffset() + offsetVector;
    }
    if (elbowJoint) {
        return elbowJoint.position + offsetVector;
    }
    return Vector3.zero + offsetVector;
  }
  ...
  */
  public Vector3 GetWristPosition() {
    ...
    if (wristJoint) {
        return wristJoint.position + offsetVector;
    }
    return Vector3.zero + offsetVector;
  }
